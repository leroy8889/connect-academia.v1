...
class Like extends BaseModel
{
    ...
    public function togglePostLike(int $userId, int $postId): array
    {
        ...
        if ($existing) {
            ...
            $this->query("INSERT INTO likes (user_id, post_id, created_at) VALUES (?, ?, NOW())", [$userId, $postId]);
        ...
        return ['liked' => $liked, 'likes_count' => (int) ($post['likes_count'] ?? 0)];
    }
    ...
    public function toggleCommentLike(int $userId, int $commentId): array
    {
        ...
        if ($existing) {
            ...
            $this->query("INSERT INTO likes (user_id, comment_id, created_at) VALUES (?, ?, NOW())", [$userId, $commentId]);
        ...
        return ['liked' => $liked, 'likes_count' => (int) ($comment['likes_count'] ?? 0)];
    }
}
